...
## 4. Detailed results: 002bmc-apalache-0.9.0.csv
...
## 7. Detailed results: 002bmc-apalache-0.15.11-SNAPSHOT.csv

01:no  |  02:tool   |  03:status  |  04:time_sec  |  05:depth  |  05:mem_kb  |  10:ninit_trans  |  11:ninit_trans  |  12:ncells  |  13:nclauses  |  14:navg_clause_len
-------|------------|-------------|---------------|------------|-------------|------------------|------------------|-------------|---------------|--------------------
1      |  apalache  |  NoError    |  3s           |  0         |  185MB      |  0               |  0               |  324        |  458          |  9.0
2      |  apalache  |  NoError    |  6m06s        |  0         |  386MB      |  0               |  0               |  1.0K       |  2.0K         |  13
3      |  apalache  |  NoError    |  11m          |  0         |  494MB      |  0               |  0               |  10K        |  18K          |  12
4      |  apalache  |  NoError    |  52s          |  0         |  534MB      |  0               |  0               |  27K        |  118K         |  17
5      |  apalache  |  NoError    |  39m          |  0         |  1.0GB      |  0               |  0               |  67K        |  293K         |  17
6      |  apalache  |  NoError    |  6s           |  0         |  230MB      |  0               |  0               |  1.0K       |  2.0K         |  13
7      |  apalache  |  NoError    |  1m01s        |  0         |  242MB      |  0               |  0               |  2.0K       |  5.0K         |  19
8      |  apalache  |  NoError    |  9s           |  0         |  303MB      |  0               |  0               |  4.0K       |  6.0K         |  15
9      |  apalache  |  NoError    |  18s          |  0         |  437MB      |  0               |  0               |  14K        |  23K          |  20
10     |  apalache  |  NoError    |  1m01s        |  0         |  591MB      |  0               |  0               |  20K        |  40K          |  20
11     |  apalache  |  NoError    |  12m          |  0         |  1023MB     |  0               |  0               |  38K        |  74K          |  26
12     |  apalache  |  NoError    |  34s          |  0         |  258MB      |  0               |  0               |  2.0K       |  4.0K         |  12
13     |  apalache  |  NoError    |  34m          |  0         |  328MB      |  0               |  0               |  3.0K       |  6.0K         |  12
14     |  apalache  |  NoError    |  45m          |  0         |  766MB      |  0               |  0               |  17K        |  24K          |  11
15     |  apalache  |  NoError    |  1h01m        |  0         |  1.0GB      |  0               |  0               |  28K        |  40K          |  11
16     |  apalache  |  NoError    |  40m          |  0         |  1.0GB      |  0               |  0               |  63K        |  132K         |  18
