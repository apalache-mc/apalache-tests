...
## 4. Detailed results: 002bmc-apalache-0.19.4-SNAPSHOT.csv

01:no  |  02:tool   |  03:status  |  04:time_sec  |  05:depth  |  05:mem_kb  |  10:ninit_trans  |  11:ninit_trans  |  12:ncells  |  13:nclauses  |  14:navg_clause_len
-------|------------|-------------|---------------|------------|-------------|------------------|------------------|-------------|---------------|--------------------
1      |  apalache  |  NoError    |  5s           |  0         |  213MB      |  0               |  0               |  328        |  482          |  9.0
2      |  apalache  |  NoError    |  5m05s        |  0         |  276MB      |  0               |  0               |  1.0K       |  2.0K         |  13
3      |  apalache  |  NoError    |  12m          |  0         |  440MB      |  0               |  0               |  10K        |  18K          |  13
4      |  apalache  |  NoError    |  1m01s        |  0         |  575MB      |  0               |  0               |  27K        |  119K         |  17
5      |  apalache  |  NoError    |  51m          |  0         |  909MB      |  0               |  0               |  68K        |  293K         |  17
6      |  apalache  |  NoError    |  9s           |  0         |  271MB      |  0               |  0               |  1.0K       |  2.0K         |  14
7      |  apalache  |  NoError    |  1m01s        |  0         |  289MB      |  0               |  0               |  2.0K       |  5.0K         |  21
8      |  apalache  |  NoError    |  13s          |  0         |  340MB      |  0               |  0               |  4.0K       |  6.0K         |  16
9      |  apalache  |  NoError    |  27s          |  0         |  622MB      |  0               |  0               |  14K        |  23K          |  21
10     |  apalache  |  NoError    |  3m03s        |  0         |  698MB      |  0               |  0               |  20K        |  37K          |  23
11     |  apalache  |  NoError    |  27m          |  0         |  1.0GB      |  0               |  0               |  38K        |  68K          |  31
12     |  apalache  |  NoError    |  47s          |  0         |  292MB      |  0               |  0               |  2.0K       |  4.0K         |  12
13     |  apalache  |  NoError    |  53m          |  0         |  345MB      |  0               |  0               |  3.0K       |  6.0K         |  13
14     |  apalache  |  NoError    |  34m          |  0         |  468MB      |  0               |  0               |  16K        |  20K          |  15
15     |  apalache  |  NoError    |  1h01m        |  0         |  654MB      |  0               |  0               |  25K        |  32K          |  15
16     |  apalache  |  NoError    |  1h01m        |  0         |  2.0GB      |  0               |  0               |  73K        |  163K         |  27
...
## 6. Detailed results: 002bmc-apalache-0.16.0.csv

01:no  |  02:tool   |  03:status  |  04:time_sec  |  05:depth  |  05:mem_kb  |  10:ninit_trans  |  11:ninit_trans  |  12:ncells  |  13:nclauses  |  14:navg_clause_len
-------|------------|-------------|---------------|------------|-------------|------------------|------------------|-------------|---------------|--------------------
1      |  apalache  |  NoError    |  3s           |  0         |  207MB      |  0               |  0               |  324        |  458          |  9.0
2      |  apalache  |  NoError    |  8m08s        |  0         |  412MB      |  0               |  0               |  1.0K       |  2.0K         |  13
3      |  apalache  |  NoError    |  12m          |  0         |  525MB      |  0               |  0               |  10K        |  18K          |  12
4      |  apalache  |  NoError    |  1m01s        |  0         |  620MB      |  0               |  0               |  27K        |  120K         |  17
5      |  apalache  |  NoError    |  42m          |  0         |  1.0GB      |  0               |  0               |  68K        |  296K         |  17
6      |  apalache  |  NoError    |  7s           |  0         |  241MB      |  0               |  0               |  1.0K       |  2.0K         |  13
7      |  apalache  |  NoError    |  1m01s        |  0         |  282MB      |  0               |  0               |  2.0K       |  5.0K         |  19
8      |  apalache  |  NoError    |  12s          |  0         |  292MB      |  0               |  0               |  4.0K       |  6.0K         |  15
9      |  apalache  |  NoError    |  19s          |  0         |  472MB      |  0               |  0               |  14K        |  23K          |  20
10     |  apalache  |  NoError    |  1m01s        |  0         |  615MB      |  0               |  0               |  20K        |  40K          |  20
11     |  apalache  |  NoError    |  16m          |  0         |  1.0GB      |  0               |  0               |  38K        |  73K          |  26
12     |  apalache  |  NoError    |  34s          |  0         |  265MB      |  0               |  0               |  2.0K       |  4.0K         |  12
13     |  apalache  |  NoError    |  41m          |  0         |  348MB      |  0               |  0               |  3.0K       |  7.0K         |  12
14     |  apalache  |  NoError    |  51m          |  0         |  849MB      |  0               |  0               |  18K        |  25K          |  11
15     |  apalache  |  NoError    |  1h01m        |  0         |  1.0GB      |  0               |  0               |  29K        |  41K          |  11
16     |  apalache  |  NoError    |  49m          |  0         |  1.0GB      |  0               |  0               |  73K        |  163K         |  25

## 7. Detailed results: 002bmc-apalache-0.9.0.csv
...
## 8. Detailed results: 002bmc-apalache-0.6.0.csv
...
## 9. Detailed results: 002bmc-apalache-0.19.2.csv

01:no  |  02:tool   |  03:status  |  04:time_sec  |  05:depth  |  05:mem_kb  |  10:ninit_trans  |  11:ninit_trans  |  12:ncells  |  13:nclauses  |  14:navg_clause_len
-------|------------|-------------|---------------|------------|-------------|------------------|------------------|-------------|---------------|--------------------
1      |  apalache  |  NoError    |  5s           |  0         |  211MB      |  0               |  0               |  328        |  482          |  9.0
2      |  apalache  |  NoError    |  4m04s        |  0         |  264MB      |  0               |  0               |  1.0K       |  2.0K         |  13
3      |  apalache  |  NoError    |  10m          |  0         |  501MB      |  0               |  0               |  10K        |  18K          |  13
4      |  apalache  |  NoError    |  1m01s        |  0         |  541MB      |  0               |  0               |  27K        |  119K         |  17
5      |  apalache  |  NoError    |  39m          |  0         |  865MB      |  0               |  0               |  68K        |  293K         |  17
6      |  apalache  |  NoError    |  8s           |  0         |  262MB      |  0               |  0               |  1.0K       |  2.0K         |  14
7      |  apalache  |  NoError    |  1m01s        |  0         |  301MB      |  0               |  0               |  2.0K       |  5.0K         |  21
8      |  apalache  |  NoError    |  12s          |  0         |  339MB      |  0               |  0               |  4.0K       |  6.0K         |  16
9      |  apalache  |  NoError    |  34s          |  0         |  597MB      |  0               |  0               |  14K        |  23K          |  21
10     |  apalache  |  NoError    |  2m02s        |  0         |  761MB      |  0               |  0               |  20K        |  37K          |  23
11     |  apalache  |  NoError    |  39m          |  0         |  1.0GB      |  0               |  0               |  38K        |  68K          |  31
12     |  apalache  |  NoError    |  42s          |  0         |  302MB      |  0               |  0               |  2.0K       |  4.0K         |  12
13     |  apalache  |  NoError    |  47m          |  0         |  357MB      |  0               |  0               |  3.0K       |  6.0K         |  13
14     |  apalache  |  NoError    |  41m          |  0         |  487MB      |  0               |  0               |  16K        |  20K          |  15
15     |  apalache  |  NoError    |  1h01m        |  0         |  616MB      |  0               |  0               |  25K        |  32K          |  15
16     |  apalache  |  NoError    |  1h01m        |  0         |  2.0GB      |  0               |  0               |  73K        |  163K         |  27
