; Quantified encoding for IntClocks_Bounded example of size 9
; Simulates bounded model checking run of length 9*10
; Created Thu Apr 30 15:16:14 CEST 2020 by andrey

(declare-datatypes () ((Values p0 p1 p2 p3 p4 p5 p6 p7 p8 )))
