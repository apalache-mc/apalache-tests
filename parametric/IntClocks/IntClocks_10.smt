; Quantified encoding for IntClocks example of size 10
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c81 x) (ite (< (select c80 x) 10) (+ (select c80 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c82 x) (ite (< (select c81 x) 10) (+ (select c81 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c83 x) (ite (< (select c82 x) 10) (+ (select c82 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c84 x) (ite (< (select c83 x) 10) (+ (select c83 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c85 x) (ite (< (select c84 x) 10) (+ (select c84 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c86 x) (ite (< (select c85 x) 10) (+ (select c85 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c87 x) (ite (< (select c86 x) 10) (+ (select c86 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c88 x) (ite (< (select c87 x) 10) (+ (select c87 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c89 x) (ite (< (select c88 x) 10) (+ (select c88 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c90 x) (ite (< (select c89 x) 10) (+ (select c89 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c91 x) (ite (< (select c90 x) 10) (+ (select c90 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c92 x) (ite (< (select c91 x) 10) (+ (select c91 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c93 x) (ite (< (select c92 x) 10) (+ (select c92 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c94 x) (ite (< (select c93 x) 10) (+ (select c93 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c95 x) (ite (< (select c94 x) 10) (+ (select c94 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c96 x) (ite (< (select c95 x) 10) (+ (select c95 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c97 x) (ite (< (select c96 x) 10) (+ (select c96 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c98 x) (ite (< (select c97 x) 10) (+ (select c97 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c99 x) (ite (< (select c98 x) 10) (+ (select c98 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c100 x) (ite (< (select c99 x) 10) (+ (select c99 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
