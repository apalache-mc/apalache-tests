; Quantified encoding for IntClocks_Bounded example of size 10
; Simulates bounded model checking run of length 10*10
; Created Thu Apr 30 15:16:16 CEST 2020 by andrey
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c41 x) (ite (< (select c40 x) 9) (+ (select c40 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c42 x) (ite (< (select c41 x) 9) (+ (select c41 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c43 x) (ite (< (select c42 x) 9) (+ (select c42 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c44 x) (ite (< (select c43 x) 9) (+ (select c43 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c45 x) (ite (< (select c44 x) 9) (+ (select c44 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c46 x) (ite (< (select c45 x) 9) (+ (select c45 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c47 x) (ite (< (select c46 x) 9) (+ (select c46 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c48 x) (ite (< (select c47 x) 9) (+ (select c47 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c49 x) (ite (< (select c48 x) 9) (+ (select c48 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c50 x) (ite (< (select c49 x) 9) (+ (select c49 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c51 x) (ite (< (select c50 x) 9) (+ (select c50 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c52 x) (ite (< (select c51 x) 9) (+ (select c51 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c53 x) (ite (< (select c52 x) 9) (+ (select c52 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c54 x) (ite (< (select c53 x) 9) (+ (select c53 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c55 x) (ite (< (select c54 x) 9) (+ (select c54 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c56 x) (ite (< (select c55 x) 9) (+ (select c55 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c57 x) (ite (< (select c56 x) 9) (+ (select c56 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c58 x) (ite (< (select c57 x) 9) (+ (select c57 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c59 x) (ite (< (select c58 x) 9) (+ (select c58 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c60 x) (ite (< (select c59 x) 9) (+ (select c59 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c61 x) (ite (< (select c60 x) 9) (+ (select c60 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c62 x) (ite (< (select c61 x) 9) (+ (select c61 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c63 x) (ite (< (select c62 x) 9) (+ (select c62 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c64 x) (ite (< (select c63 x) 9) (+ (select c63 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c65 x) (ite (< (select c64 x) 9) (+ (select c64 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c66 x) (ite (< (select c65 x) 9) (+ (select c65 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c67 x) (ite (< (select c66 x) 9) (+ (select c66 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c68 x) (ite (< (select c67 x) 9) (+ (select c67 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c69 x) (ite (< (select c68 x) 9) (+ (select c68 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c70 x) (ite (< (select c69 x) 9) (+ (select c69 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c71 x) (ite (< (select c70 x) 9) (+ (select c70 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c72 x) (ite (< (select c71 x) 9) (+ (select c71 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c73 x) (ite (< (select c72 x) 9) (+ (select c72 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c74 x) (ite (< (select c73 x) 9) (+ (select c73 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c75 x) (ite (< (select c74 x) 9) (+ (select c74 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c76 x) (ite (< (select c75 x) 9) (+ (select c75 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c77 x) (ite (< (select c76 x) 9) (+ (select c76 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c78 x) (ite (< (select c77 x) 9) (+ (select c77 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c79 x) (ite (< (select c78 x) 9) (+ (select c78 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c80 x) (ite (< (select c79 x) 9) (+ (select c79 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
...
(declare-const c81 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c81 x) (ite (< (select c80 x) 9) (+ (select c80 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c81 y) (select c80 y))
        )
      )
    )
  )
...
(declare-const c82 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c82 x) (ite (< (select c81 x) 9) (+ (select c81 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c82 y) (select c81 y))
        )
      )
    )
  )
...
(declare-const c83 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c83 x) (ite (< (select c82 x) 9) (+ (select c82 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c83 y) (select c82 y))
        )
      )
    )
  )
...
(declare-const c84 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c84 x) (ite (< (select c83 x) 9) (+ (select c83 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c84 y) (select c83 y))
        )
      )
    )
  )
...
(declare-const c85 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c85 x) (ite (< (select c84 x) 9) (+ (select c84 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c85 y) (select c84 y))
        )
      )
    )
  )
...
(declare-const c86 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c86 x) (ite (< (select c85 x) 9) (+ (select c85 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c86 y) (select c85 y))
        )
      )
    )
  )
...
(declare-const c87 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c87 x) (ite (< (select c86 x) 9) (+ (select c86 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c87 y) (select c86 y))
        )
      )
    )
  )
...
(declare-const c88 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c88 x) (ite (< (select c87 x) 9) (+ (select c87 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c88 y) (select c87 y))
        )
      )
    )
  )
...
(declare-const c89 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c89 x) (ite (< (select c88 x) 9) (+ (select c88 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c89 y) (select c88 y))
        )
      )
    )
  )
...
(declare-const c90 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c90 x) (ite (< (select c89 x) 9) (+ (select c89 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c90 y) (select c89 y))
        )
      )
    )
  )
...
(declare-const c91 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c91 x) (ite (< (select c90 x) 9) (+ (select c90 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c91 y) (select c90 y))
        )
      )
    )
  )
...
(declare-const c92 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c92 x) (ite (< (select c91 x) 9) (+ (select c91 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c92 y) (select c91 y))
        )
      )
    )
  )
...
(declare-const c93 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c93 x) (ite (< (select c92 x) 9) (+ (select c92 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c93 y) (select c92 y))
        )
      )
    )
  )
...
(declare-const c94 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c94 x) (ite (< (select c93 x) 9) (+ (select c93 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c94 y) (select c93 y))
        )
      )
    )
  )
...
(declare-const c95 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c95 x) (ite (< (select c94 x) 9) (+ (select c94 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c95 y) (select c94 y))
        )
      )
    )
  )
...
(declare-const c96 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c96 x) (ite (< (select c95 x) 9) (+ (select c95 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c96 y) (select c95 y))
        )
      )
    )
  )
...
(declare-const c97 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c97 x) (ite (< (select c96 x) 9) (+ (select c96 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c97 y) (select c96 y))
        )
      )
    )
  )
...
(declare-const c98 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c98 x) (ite (< (select c97 x) 9) (+ (select c97 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c98 y) (select c97 y))
        )
      )
    )
  )
...
(declare-const c99 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c99 x) (ite (< (select c98 x) 9) (+ (select c98 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c99 y) (select c98 y))
        )
      )
    )
  )
...
(declare-const c100 (Array Values Int))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (= (select c100 x) (ite (< (select c99 x) 9) (+ (select c99 x) 1) 0))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select c100 y) (select c99 y))
        )
      )
    )
  )
