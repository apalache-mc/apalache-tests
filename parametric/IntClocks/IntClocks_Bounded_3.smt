; Quantified encoding for IntClocks_Bounded example of size 3
; Simulates bounded model checking run of length 3*10
; Created Thu Apr 30 15:16:09 CEST 2020 by andrey

(declare-datatypes () ((Values p0 p1 p2 )))
