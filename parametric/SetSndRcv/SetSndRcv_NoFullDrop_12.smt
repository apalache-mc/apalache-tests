; Quantified encoding for SetSndRcv_NoFullDrop example of size 12
; Simulates bounded model checking run of length 2*12
; Created Tue Apr 28 15:57:57 CEST 2020 by andrey

(declare-datatypes () ((Values p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 )))
