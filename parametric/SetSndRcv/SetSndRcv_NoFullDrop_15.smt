; Quantified encoding for SetSndRcv_NoFullDrop example of size 15
; Simulates bounded model checking run of length 2*15
; Created Tue Apr 28 15:58:00 CEST 2020 by andrey

(declare-datatypes () ((Values p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14 )))
...
(declare-const s21 (Set Values))
(declare-const r21 (Set Values))
(declare-const m21 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s20 x) (not (select s21 x))
      (select m21 x) (not (select m20 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s21 y) (select s20 y))
             (= (select m21 y) (select m20 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m20 y)
      (select m20 x) (not (select m21 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r21 x) (not (select r20 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r21 y) (select r20 y))
        )
      )
    )
  ))
...
(declare-const s22 (Set Values))
(declare-const r22 (Set Values))
(declare-const m22 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s21 x) (not (select s22 x))
      (select m22 x) (not (select m21 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s22 y) (select s21 y))
             (= (select m22 y) (select m21 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m21 y)
      (select m21 x) (not (select m22 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r22 x) (not (select r21 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r22 y) (select r21 y))
        )
      )
    )
  ))
...
(declare-const s23 (Set Values))
(declare-const r23 (Set Values))
(declare-const m23 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s22 x) (not (select s23 x))
      (select m23 x) (not (select m22 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s23 y) (select s22 y))
             (= (select m23 y) (select m22 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m22 y)
      (select m22 x) (not (select m23 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r23 x) (not (select r22 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r23 y) (select r22 y))
        )
      )
    )
  ))
...
(declare-const s24 (Set Values))
(declare-const r24 (Set Values))
(declare-const m24 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s23 x) (not (select s24 x))
      (select m24 x) (not (select m23 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s24 y) (select s23 y))
             (= (select m24 y) (select m23 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m23 y)
      (select m23 x) (not (select m24 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r24 x) (not (select r23 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r24 y) (select r23 y))
        )
      )
    )
  ))
...
(declare-const s25 (Set Values))
(declare-const r25 (Set Values))
(declare-const m25 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s24 x) (not (select s25 x))
      (select m25 x) (not (select m24 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s25 y) (select s24 y))
             (= (select m25 y) (select m24 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m24 y)
      (select m24 x) (not (select m25 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r25 x) (not (select r24 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r25 y) (select r24 y))
        )
      )
    )
  ))
...
(declare-const s26 (Set Values))
(declare-const r26 (Set Values))
(declare-const m26 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s25 x) (not (select s26 x))
      (select m26 x) (not (select m25 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s26 y) (select s25 y))
             (= (select m26 y) (select m25 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m25 y)
      (select m25 x) (not (select m26 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r26 x) (not (select r25 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r26 y) (select r25 y))
        )
      )
    )
  ))
...
(declare-const s27 (Set Values))
(declare-const r27 (Set Values))
(declare-const m27 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s26 x) (not (select s27 x))
      (select m27 x) (not (select m26 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s27 y) (select s26 y))
             (= (select m27 y) (select m26 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m26 y)
      (select m26 x) (not (select m27 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r27 x) (not (select r26 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r27 y) (select r26 y))
        )
      )
    )
  ))
...
(declare-const s28 (Set Values))
(declare-const r28 (Set Values))
(declare-const m28 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s27 x) (not (select s28 x))
      (select m28 x) (not (select m27 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s28 y) (select s27 y))
             (= (select m28 y) (select m27 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m27 y)
      (select m27 x) (not (select m28 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r28 x) (not (select r27 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r28 y) (select r27 y))
        )
      )
    )
  ))
...
(declare-const s29 (Set Values))
(declare-const r29 (Set Values))
(declare-const m29 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s28 x) (not (select s29 x))
      (select m29 x) (not (select m28 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s29 y) (select s28 y))
             (= (select m29 y) (select m28 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m28 y)
      (select m28 x) (not (select m29 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r29 x) (not (select r28 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r29 y) (select r28 y))
        )
      )
    )
  ))
...
(declare-const s30 (Set Values))
(declare-const r30 (Set Values))
(declare-const m30 (Set Values))
...
(assert (or
  ...
  (exists 
    ((x Values)) 
    (and 
      (select s29 x) (not (select s30 x))
      (select m30 x) (not (select m29 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (and
             (= (select s30 y) (select s29 y))
             (= (select m30 y) (select m29 y))
           )
        )
      )
    )
  ...
  (exists 
    ((x Values) (y Values)) 
    (and 
      (not (= x y)) (select m29 y)
      (select m29 x) (not (select m30 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
  ...
  (exists 
    ((x Values)) 
    (and 
      (select r30 x) (not (select r29 x))
      (forall 
        ((y Values))
        (=>
           (not (= x y))
           (= (select r30 y) (select r29 y))
        )
      )
    )
  ))
